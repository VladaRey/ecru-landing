...
// ЗАГЛУШКА: замінити на справжню адресу до того, як політика поїде в main.
...
// правці. App Store Connect вимагає робочого контакту, тож заглушка на
// опублікованій сторінці — це відмова на рев'ю.
const CONTACT_EMAIL = 'ПОШТА_СЮДИ';
